...
class AccountController extends Controller
{
   ...
   * Test
   */
  // public function xgetBanks(Request $request)
  // {
  //   $user_id = 1;
   ...
   * 個人の一つ口座を参照
   */
  public function postBanks(Request $request, int $id)
  {
   ...
   * account_name
   */
  public function putBanks(Request $request, int $id)
  {
    $user_id = 1;
    if (Bank::where('id', $id)->exists()) {
      $bank = Bank::find($id);
   ...
   * account_name
   */
  public function xpostBanks(Request $request)
  {
    $user_id = 1;
    $bank = new Bank();
