            ...
            <perfect-scrollbar class="sidbarchat p-3" tag="div">
                ...
                <div class="btn-group-toggle row mb-4 mx-0">
                    ...
                    >
                        <input
                            ...
                            @change="setMenuStyle"
                        />
                        <label class="custom-control-label" for="horizontal"
                            >Horizontal</label
                        >
                    </div>
                    <div
                    ...
                    >
                        <input
                            ...
                            @change="setMenuStyle"
                        />
                        <label class="custom-control-label" for="vertical"
                            >Vertical</label
                        >
                    </div>
                    <div
                    ...
                    >
                        <input
                            ...
                            @change="setMenuStyle"
                        />
                        <label class="custom-control-label" for="collapsible"
                            >Collapsible Vertical</label
                        >
                    </div>
                </div>
                ...
                <div class="btn-group-toggle row mx-0">
                    ...
                    >
                        ...
                        />
                        <label class="custom-control-label" for="boxed"
                            >Box</label
                        >
                    </div>
                    <div
                    ...
                    >
                        <input
                            ...
                            @change="setLayoutStyle"
                        />
                        <label class="custom-control-label" for="largeboxed"
                            >Large box</label
                        >
                    </div>
                    <div
